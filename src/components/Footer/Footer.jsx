      ...
      <footer class="w-full py-14">
        <div class="mx-auto container px-4 sm:px-6 lg:px-8">
          <div class="border-b border-gray-200 pb-14 flex justify-between items-center flex-col gap-8 lg:gap-0 lg:flex-row">
            <div class="block">
              <h3 class="font-manrope text-3xl text-gray-900 font-bold mb-2 text-center lg:text-left">
            ...
            <div class="flex items-center flex-col gap-4 lg:flex-row">
              <input
                type="text"
                name="email"
                class="py-3 px-6 h-14 border border-gray-300 shadow-sm rounded-full focus:outline-none"
                placeholder="Enter your mail.."
              />
              <button class="h-14 py-3.5 px-7 bg-gray-100 shadow-sm rounded-full text-black  font-bold">
                Subscribe
              </button>
            </div>
          </div>
          ...
          <div class="grid grid-cols-2 min-[690px]:grid-cols-4 lg:grid-cols-6 gap-4 xl:gap-8 pt-14 pb-10 max-w-xs mx-auto min-[690px]:max-w-2xl lg:max-w-full">
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              <a
                href="www.devtechltd.xyz"
                class="flex justify-center lg:justify-start"
              >
                <h1 className=" font-bold  text-7xl justify-center ">
                  DevTech.
                </h1>
              </a>
            ...
            <div class="lg:mx-auto text-left ">
              <h4 class="text-lg text-gray-900 font-medium mb-7">DevTech.</h4>
          ...
          <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span class="text-sm text-gray-500 ">
                ©<a href="https://pagedone.io/">DevTech. </a>2025, All rights
                reserved.
              </span>
